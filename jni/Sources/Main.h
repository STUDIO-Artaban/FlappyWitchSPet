...
#error "Invalid libeng version: Expected 1.2.8 version"
    ...
    (!defined(LIBENG_USE_RTTI) && defined(__ANDROID__)) || \
...
#define PROJECT_NAME            "WitchSPet"
#ifdef __ANDROID__
#define JAVA_PROJECT_NAME       "com/studio/artaban/witchspet"
...
inline void init(PlatformData& data) {
    ...
    data.game = static_cast<Game*>(WitchSPet::getInstance());
}
